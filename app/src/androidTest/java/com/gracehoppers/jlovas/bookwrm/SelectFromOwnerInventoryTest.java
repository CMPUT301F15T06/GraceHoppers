 ...
 */
public class SelectFromOwnerInventoryTest extends ActivityInstrumentationTestCase2 {

    public SelectFromOwnerInventoryTest() {
        super(SelectFromOwnerInventoryActivity.class);
    }
    ...
    public void testGoingBackToTrade(){
        SelectFromOwnerInventoryActivity activity = (SelectFromOwnerInventoryActivity) getActivity();
